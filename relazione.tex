...
\begin{itemize}
    \item Progettazione sito;
    \item Design mobile in Balsamiq;
    \item Sviluppo CSS vari;
    \item Progettazione database;
    \item Implementazione file SQL per il database;
    \item Gestione collegamento al database;
    \item Gestione navbar in PHP;
    \item Gestione script backend in PHP;
    \item Validazione input lato client in JavaScript;
    \item Validazione input lato server in PHP;
    \item Creazione e modifica di pagine HTML;
    \item Test con Total Validator, WCAG Color Contrast Checker, HTML W3C, CSS W3C, w3ba11y;
    \item Correzioni e fix vari.   
\end{itemize}
