...
L’uso di Total Validator ha permesso di identificare diverse problematiche di semantica e struttura. Tra queste, la mancanza della caption nella tabella delle categorie nella pagina "Home", che è stata prontamente aggiunta per migliorare la comprensione del contenuto tabellare da parte degli screen reader.
Nelle card e nella navbar, il validatore segnala la presenza di link adiacenti con contenuti simili: nelle card i link differiscono solo per la query string, mentre nella navbar il logo e il link "Home" puntano alla stessa destinazione. Entrambe le scelte sono intenzionali e non rappresentano problemi effettivi, in quanto non influiscono né sull’usabilità né sull’esperienza utente.
