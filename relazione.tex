...
\begin{itemize}
    ...
    \item Creazione e modifica di pagine HTML;
    \item Sviluppo di fogli di stile CSS;
    \item Progettazione del database;
    \item Gestione di script backend in PHP;
    \item Implementazione degli skip-buttons nel sito;
    \item Test del sito con strumenti Total Validator, WAVE e w3ba11y;
...
\begin{itemize}
    ...
    \item Visualizzazione di filtri aggiuntivi per gli NFT mediante JavaScript;
    \item Stesura della relazione;
    \item Correzioni e fix vari.
\end{itemize}
...
\begin{itemize}
    ...
    \item Creazione e modifica di pagine HTML;
    \item Sviluppo CSS vari;
    \item Progettazione database;
    \item Progettazione concettuale e logica;
    \item Implementazione script backend in PHP;
    \item Test con CSS W3C, WAVE e w3ba11y;
...
\begin{itemize}
    ...
    \item Correzioni e miglioramenti vari.
\end{itemize}
