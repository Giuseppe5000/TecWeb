...
\begin{itemize}
    ...
    \item \textbf{Boa di segnalazione:} L'utente può distinguere le opere già visionate in passato da quelle non visionate, grazie al fatto che i nomi delle opere sono dei link che giustamente cambiano colore quando visitati.
\end{itemize}
