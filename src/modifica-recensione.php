...
function getForm($voto, $commento, $timestamp,$prevPage) {
    ...
    $form .= '<input aria-label="una stella" type="radio" id="voto-1" name="voto" value="1"' . ($voto == 1 ? " checked" : ""). '>';
    $form .= '<label aria-hidden="true" class="star" for="voto-1">&#9733;</label>';
    $form .= '<input aria-label="due stelle" type="radio" id="voto-2" name="voto" value="2"' . ($voto == 2 ? " checked" : ""). '>';
    $form .= '<label aria-hidden="true" class="star" for="voto-2">&#9733;</label>';
    $form .= '<input aria-label="tre stelle" type="radio" id="voto-3" name="voto" value="3"' . ($voto == 3 ? " checked" : ""). '>';
    $form .= '<label aria-hidden="true" class="star" for="voto-3">&#9733;</label>';
    $form .= '<input aria-label="quattro stelle" type="radio" id="voto-4" name="voto" value="4"' . ($voto == 4 ? " checked" : ""). '>';
    $form .= '<label aria-hidden="true" class="star" for="voto-4">&#9733;</label>';
    $form .= '<input aria-label="cinque stelle" type="radio" id="voto-5" name="voto" value="5"' . ($voto == 5 ? " checked" : ""). '>';
    $form .= '<label aria-hidden="true" class="star" for="voto-5">&#9733;</label>';
    $form .= '</fieldset>';
