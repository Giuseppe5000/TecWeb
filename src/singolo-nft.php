...
function mostraAggiungiRecensione(&$aggiungi_recensione_html, $id) {
    ...
    $aggiungi_recensione_html.= '<option value="4" label="4&#9733;"></option>';
    $aggiungi_recensione_html.= '<option value="5" label="5&#9733;"></option>';
    $aggiungi_recensione_html.= '</datalist>';
...
if (!$connessioneOK) {
    ...
    $totalPages = floor(count($recensioni) / $pageSize)+1;
}else{
