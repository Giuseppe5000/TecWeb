...
function mostraAggiungiRecensione(&$aggiungi_recensione_html, $id) {
    ...
    $aggiungi_recensione_html.= '<input aria-label="una stella" type="radio" id="voto-1" name="voto" value="1" checked>';
    $aggiungi_recensione_html.= '<label aria-hidden="true" class="star" for="voto-1">&#9733;</label>';
    $aggiungi_recensione_html.= '<input aria-label="due stelle" type="radio" id="voto-2" name="voto" value="2">';
    $aggiungi_recensione_html.= '<label aria-hidden="true" class="star" for="voto-2">&#9733;</label>';
    $aggiungi_recensione_html.= '<input aria-label="tre stelle" type="radio" id="voto-3" name="voto" value="3">';
    $aggiungi_recensione_html.= '<label aria-hidden="true" class="star" for="voto-3">&#9733;</label>';
    $aggiungi_recensione_html.= '<input aria-label="quattro stelle" type="radio" id="voto-4" name="voto" value="4">';
    $aggiungi_recensione_html.= '<label aria-hidden="true" class="star" for="voto-4">&#9733;</label>';
    $aggiungi_recensione_html.= '<input aria-label="cinque stelle" type="radio" id="voto-5" name="voto" value="5">';
    $aggiungi_recensione_html.= '<label aria-hidden="true" class="star" for="voto-5">&#9733;</label>';
    $aggiungi_recensione_html.= '</fieldset>';
