...
(6, 'assets/nft6', 'Rettangoli Monocromatici', 'Forme rettangolari astratte in bianco e nero. La semplicità delle forme geometriche invita a riflettere sulla bellezza della minimalismo. La scelta del colore monocromatico enfatizza unità e la coesione.', 40.10),
(7, 'assets/nft7', 'Rettangoli Vivaci', 'Una rappresentazione astratta con forme rettangolari in rosso, bianco e nero. Un invito a celebrare la gioia ed energia che i colori possono portare nella nostra vita.', 42.30),
(8, 'assets/nft8', 'Scimmia Sorridente', 'Una scimmia con un sorriso luminoso. In perfetta sintonia con la natura che la circonda. Il suo sorriso contagioso invita chiunque la osservi a unirsi alla sua gioia e spensieratezza.', 50.00),
...
(13, 'assets/nft13', 'Broly', 'Un gattino pixelato dai colori verdi. Il suo pelo, di un verde brillante e vivace, sembra quasi brillare sotto la luce. Crea intorno a se un contrasto sorprendente con il mondo circostante.', 35.00),
(14, 'assets/nft14', 'Gatto Blu', 'Un gattino pixelato con tonalità di blu. Questo gatto blu si muove con eleganza, le sue zampe agili e silenziose lo rendono un cacciatore esperto. Il suo aspetto incantevole lo fa sembrare più un esploratore che un predatore.', 36.00),
